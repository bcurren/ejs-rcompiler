...
module Ejs
  ...
  class Compiler
    ...
    def compile(source_path, target_path = source_path.gsub(/\.ejs\Z/, '.js'))
      template_name = File.basename(source_path, ".ejs")
      
      File.open(target_path, 'w') do |target_file|
        target_file.write(AUTOGENERATED+"\n\n")
        target_file.write(js_source(template_name, source_path))
      end
    end
    
    # compile a ejs file into javascript
    def js_source(template_name, source_path, output_as_array = false)
